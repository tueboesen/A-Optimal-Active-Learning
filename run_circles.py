...
parser.add_argument('--nrepeats', default=3, type=int, metavar='N',help='Number of times the code will be rerun')
...
parser.add_argument('--nsamples-train', default=1000, type=int, metavar='N',help='Number of datasamples')
parser.add_argument('--nsamples-test', default=100, type=int, metavar='N',help='Number of datasamples')
parser.add_argument('--nlabels', default=3, type=int, metavar='N',help='Number of labels to start with')
...
parser.add_argument('--binary', default=[], type=list, metavar='N',help='A list of length 2 with the labels in the 1 vs labels in the second 2, empty list will cancel binary. Example use would be [[1,3,5,7,9],[0,2,4,6,8]], to do a binary comparison of odd vs even labels')
#Feature Transform
parser.add_argument('--feature-transform', default='', type=str, metavar='N',help='Type of feature transform to use on data before computing graph Laplacian: "autoencoder" or ""')
...
parser.add_argument('--FT-epochs', default=100, type=int, metavar='N',help='Number of Epochs to run feature transform')
#Graph Laplacian
