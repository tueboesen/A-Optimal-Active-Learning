...
context = {
    ...
    #Supervised learning
    'use_SL': False,
    'epochs_SL': 100,                                         #Epochs for supervised learning
    'lr': 1e-2,
    ...
    #Active learning
    'epochs_AL': 24,                                        #Iterations to use in Active learning
    'lr_AL': 1e-3,
    'nlabels_pr_class': 4,                                  #Number of labels to learn in each iteration
    'alpha': 1,
    'sigma': 0,
    'beta': 0,
    'use_1_vs_all': True,
