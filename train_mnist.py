...
parser.add_argument('--nrepeats', default=10, type=int, metavar='N',help='Number of times the code will be rerun')
...
#Active Learning
parser.add_argument('--AL-iterations', default=40, type=int, metavar='N',help='Number of active learning iterations to run')
...
parser.add_argument('--AL-sigma', default=1e-2, type=float, metavar='N',help='Hyperparameter, adjusts the strength of bias versus variance')
