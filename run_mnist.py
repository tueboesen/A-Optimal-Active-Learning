...
parser.add_argument('--nsamples-train', default=600, type=int, metavar='N',help='Number of datasamples')
parser.add_argument('--nsamples-test', default=100, type=int, metavar='N',help='Number of datasamples')
parser.add_argument('--nlabels', default=100, type=int, metavar='N',help='Number of labels to start with')
...
parser.add_argument('--AL-iterations', default=50, type=int, metavar='N',help='Number of active learning iterations to run')
...
parser.add_argument('--SL-epochs-init', default=50, type=int, metavar='N',help='Number of epochs to train the network the first time')
parser.add_argument('--SL-epochs', default=20, type=int, metavar='N',help='Number of epochs to train the network')
