...
parser.add_argument('--nsamples', default=5000, type=int, metavar='N',help='Number of datasamples')
parser.add_argument('--nlabels', default=1000, type=int, metavar='N',help='Number of labels to start with')
...
parser.add_argument('--FT-epochs', default=10, type=int, metavar='N',help='Number of Epochs to run feature transform')
#Graph Laplacian
...
parser.add_argument('--AL-iterations', default=20, type=int, metavar='N',help='Number of active learning iterations to run')
...
parser.add_argument('--SL-epochs-init', default=20, type=int, metavar='N',help='Number of epochs to train the network the first time')
parser.add_argument('--SL-epochs', default=10, type=int, metavar='N',help='Number of epochs to train the network')
